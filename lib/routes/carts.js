                        ...
                        _data.read('menu-items', productId, (err, productData) => {
                            if(!err && productData) {
                                ...
                                if(userCart.length < 1) {
                                    ...
                                    // Get cartTotal
                                    const cartTotal = Number(productData.Price) * Number(productData.quantity);
                                    console.log(products[productData.name].itemTotal)
                            ...
                            if (!err && productData) {
                                ...
                                if(action == 'add') {
                                    if (cartData.products[productData.name]) {
                                        ...
                                        cartData.cartTotal += cartData.products[productData.name].Price * quantity;
                                    } else {
                                        productData.quantity = quantity;
                                ...
                                cartData.cartTotal = Number(cartData.cartTotal.toFixed(2));
